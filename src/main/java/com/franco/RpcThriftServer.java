...
import com.franco.service.RpcUserServiceImpl;
...
@Component
public class RpcThriftServer implements InitializingBean {
    ...
    public void start() {
        RpcUserService.Processor<RpcUserService.Iface> processor = new RpcUserService.Processor<>(userService);
        try {
